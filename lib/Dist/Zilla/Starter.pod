...
L<CPAN::Meta::Spec/release_status> of the distribution. It defaults to
C<stable> and is usually set to another value by passing the C<--trial> option
to L<dzil release|Dist::Zilla::App::Command::release> or using a version
